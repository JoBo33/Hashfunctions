...
QT_MOC_LITERAL(1, 5, 15), // "chooseAlgorithm"
QT_MOC_LITERAL(2, 21, 0) // ""

    },
    "hash\0chooseAlgorithm\0"
};
...
void hash::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<hash *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->chooseAlgorithm(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject hash::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_hash.data,
    qt_meta_data_hash,
    qt_static_metacall,
    nullptr,
    nullptr
